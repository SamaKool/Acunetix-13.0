...
const RegisterPage = () => {
  ...
  useEffect(() => {
    const saved = sessionStorage.getItem('registerColForm');
    if (saved) {
      try {
        setForm(JSON.parse(saved));
      } catch (e) {}
    }
    const savedStep = sessionStorage.getItem('registerColStep');
    if (savedStep === 'true') {
  ...
  useEffect(() => {
    sessionStorage.setItem('registerColForm', JSON.stringify(form));
    sessionStorage.setItem('registerColStep', showPaymentSection.toString());
  ...
  const handleFileChange = (e) => {
    ...
    const uniqueFileName = `COL_${cleanPhone}_${timestamp}.${extension}`;
      ...
      try {
        ...
        if(result.status === 'success') {
           setModalConfig({
             ...
             isError: false,
             onClose: () => {
                sessionStorage.removeItem('registerColForm');
                sessionStorage.removeItem('registerColStep');
                navigate('/');
             }
           });
        } else {
    ...
    >
      ...
      <div className="relative z-10 grow flex flex-col items-center justify-center px-4 py-24 sm:py-32">
        ...
        >
          ...
          >
            "Trust No One" — Secure your spot now.
          </motion.p>
          ...
          <form onSubmit={handleSubmit} className="register-form" autoComplete="off">
            ...
            >
              <label htmlFor="register-name" className="register-label">Full Name *</label>
              <input
                id="register-name"
                type="text"
                name="name"
            ...
            <motion.div
              ...
              variants={fieldVariants}
            >
              <label htmlFor="register-phone" className="register-label">Phone *</label>
              <input
                id="register-phone"
                type="tel"
                name="phone"
            ...
            <motion.div
              ...
              variants={fieldVariants}
            >
              <label htmlFor="register-department" className="register-label">Department / Branch *</label>
              <input
            ...
            <motion.div
              ...
              variants={fieldVariants}
            >
              <label htmlFor="register-team-size" className="register-label">Team Size *</label>
              <select
                id="register-team-size"
                name="teamSize"
                value={form.teamSize}
                onChange={handleChange}
                required
            ...
            {form.teamSize === '2' && (
              <motion.div
                ...
                variants={fieldVariants}
              >
                <label htmlFor="register-teamName" className="register-label">
                  Team Name *
                </label>
                <input
