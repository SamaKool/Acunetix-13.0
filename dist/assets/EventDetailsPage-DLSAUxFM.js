import{r as K,j,u as Sh,a as Rh,F as Ih,N as kh,R as Th}from"./index-DtnOIqbI.js";import{e as Ah}from"./eventsData-ykql_ZU1.js";import{V as Ae,U as Xn,S as at,D as Dh,a as Mh,b as Nh,c as Fh,W as Nn,L as Sa,d as Re,B as $a,e as Ra,O as vi,M as mi,C as Ho,f as aa,g as oa,h as pn,F as Ph,E as gi,i as Ou,N as Lu,j as _r,R as Uu,P as Bh,A as Oh,k as Wu,T as zu,l as Lh,m as Es,n as _s,o as Vu,p as Uh,q as Vn,r as Gu,s as Nt,t as Wh}from"./three.module-DAZc3tCW.js";import{M as zh,i as Ss,u as Hu,P as Vh,a as Gh,b as Hh,L as jh,r as qh,m as Ft,S as Xh}from"./ShapeGrid-BEgJr3J4.js";function Rs(n,t){if(typeof n=="function")return n(t);n!=null&&(n.current=t)}function Kh(...n){return t=>{let e=!1;const r=n.map(a=>{const o=Rs(a,t);return!e&&typeof o=="function"&&(e=!0),o});if(e)return()=>{for(let a=0;a<r.length;a++){const o=r[a];typeof o=="function"?o():Rs(n[a],null)}}}}function Yh(...n){return K.useCallback(Kh(...n),n)}class $h extends K.Component{getSnapshotBeforeUpdate(t){const e=this.props.childRef.current;if(e&&t.isPresent&&!this.props.isPresent&&this.props.pop!==!1){const r=e.offsetParent,a=Ss(r)&&r.offsetWidth||0,o=Ss(r)&&r.offsetHeight||0,i=this.props.sizeRef.current;i.height=e.offsetHeight||0,i.width=e.offsetWidth||0,i.top=e.offsetTop,i.left=e.offsetLeft,i.right=a-i.width-i.left,i.bottom=o-i.height-i.top}return null}componentDidUpdate(){}render(){return this.props.children}}function Qh({children:n,isPresent:t,anchorX:e,anchorY:r,root:a,pop:o}){const i=K.useId(),s=K.useRef(null),u=K.useRef({width:0,height:0,top:0,left:0,right:0,bottom:0}),{nonce:c}=K.useContext(zh),l=n.props?.ref??n?.ref,h=Yh(s,l);return K.useInsertionEffect(()=>{const{width:f,height:d,top:p,left:v,right:m,bottom:g}=u.current;if(t||o===!1||!s.current||!f||!d)return;const x=e==="left"?`left: ${v}`:`right: ${m}`,b=r==="bottom"?`bottom: ${g}`:`top: ${p}`;s.current.dataset.motionPopId=i;const y=document.createElement("style");c&&(y.nonce=c);const w=a??document.head;return w.appendChild(y),y.sheet&&y.sheet.insertRule(`
        ...
        `),()=>{w.contains(y)&&w.removeChild(y)}},[t]),j.jsx($h,{isPresent:t,childRef:s,sizeRef:u,pop:o,children:o===!1?n:K.cloneElement(n,{ref:h})})}const Jh=({children:n,initial:t,isPresent:e,onExitComplete:r,custom:a,presenceAffectsLayout:o,mode:i,anchorX:s,anchorY:u,root:c})=>{const l=Hu(Zh),h=K.useId();let f=!0,d=K.useMemo(()=>(f=!1,{id:h,initial:t,isPresent:e,custom:a,onExitComplete:p=>{l.set(p,!0);for(const v of l.values())if(!v)return;r&&r()},register:p=>(l.set(p,!1),()=>l.delete(p))}),[e,l,r]);return o&&f&&(d={...d}),K.useMemo(()=>{l.forEach((p,v)=>l.set(v,!1))},[e]),K.useEffect(()=>{!e&&!l.size&&r&&r()},[e]),n=j.jsx(Qh,{pop:i==="popLayout",isPresent:e,anchorX:s,anchorY:u,root:c,children:n}),j.jsx(Vh.Provider,{value:d,children:n})};function Zh(){return new Map}const ia=n=>n.key||"";function Is(n){const t=[];return K.Children.forEach(n,e=>{K.isValidElement(e)&&t.push(e)}),t}const ef=({children:n,custom:t,initial:e=!0,onExitComplete:r,presenceAffectsLayout:a=!0,mode:o="sync",propagate:i=!1,anchorX:s="left",anchorY:u="top",root:c})=>{const[l,h]=Gh(i),f=K.useMemo(()=>Is(n),[n]),d=i&&!l?[]:f.map(ia),p=K.useRef(!0),v=K.useRef(f),m=Hu(()=>new Map),g=K.useRef(new Set),[x,b]=K.useState(f),[y,w]=K.useState(f);Hh(()=>{p.current=!1,v.current=f;for(let S=0;S<y.length;S++){const _=ia(y[S]);d.includes(_)?(m.delete(_),g.current.delete(_)):m.get(_)!==!0&&m.set(_,!1)}},[y,d.length,d.join("-")]);const C=[];if(f!==x){let S=[...f];for(let _=0;_<y.length;_++){const R=y[_],D=ia(R);d.includes(D)||(S.splice(_,0,R),C.push(R))}return o==="wait"&&C.length&&(S=C),w(Is(S)),b(f),null}const{forceRender:I}=K.useContext(jh);return j.jsx(j.Fragment,{children:y.map(S=>{const _=ia(S),R=i&&!l?!1:f===y||d.includes(_),D=()=>{if(g.current.has(_))return;if(g.current.add(_),m.has(_))m.set(_,!0);else return;let T=!0;m.forEach(O=>{O||(T=!1)}),T&&(I?.(),w(v.current),i&&h?.(),r&&r())};return j.jsx(Jh,{isPresent:R,initial:!p.current||e?void 0:!1,custom:t,presenceAffectsLayout:a,mode:o,root:c,onExitComplete:R?void 0:D,anchorX:s,anchorY:u,children:S},_)})})},tf={some:0,all:1};function nf(n,t,{root:e,margin:r,amount:a="some"}={}){const o=qh(n),i=new WeakMap,s=c=>{c.forEach(l=>{const h=i.get(l.target);if(l.isIntersecting!==!!h)if(l.isIntersecting){const f=t(l.target,l);typeof f=="function"?i.set(l.target,f):u.unobserve(l.target)}else typeof h=="function"&&(h(l),i.delete(l.target))})},u=new IntersectionObserver(s,{root:e,rootMargin:r,threshold:typeof a=="number"?a:tf[a]});return o.forEach(c=>u.observe(c)),()=>u.disconnect()}function rf(n,{root:t,margin:e,amount:r,once:a=!1,initial:o=!1}={}){const[i,s]=K.useState(o);return K.useEffect(()=>{if(!n.current||a&&i)return;const u=()=>(s(!0),a?void 0:()=>s(!1)),c={root:t&&t.current||void 0,margin:e,amount:r};return nf(n.current,u,c)},[t,n,e,a,r]),i}var vo=1/1e3,af=1e3,of=class{constructor(){this.startTime=performance.now(),this.previousTime=0,this.currentTime=0,this._delta=0,this._elapsed=0,this._fixedDelta=1e3/60,this.timescale=1,this.useFixedDelta=!1,this._autoReset=!1}get autoReset(){return this._autoReset}set autoReset(n){typeof document<"u"&&document.hidden!==void 0&&(n?document.addEventListener("visibilitychange",this):document.removeEventListener("visibilitychange",this),this._autoReset=n)}get delta(){return this._delta*vo}get fixedDelta(){return this._fixedDelta*vo}set fixedDelta(n){this._fixedDelta=n*af}get elapsed(){return this._elapsed*vo}update(n){this.useFixedDelta?this._delta=this.fixedDelta:(this.previousTime=this.currentTime,this.currentTime=(n!==void 0?n:performance.now())-this.startTime,this._delta=this.currentTime-this.previousTime),this._delta*=this.timescale,this._elapsed+=this._delta}reset(){this._delta=0,this._elapsed=0,this.currentTime=performance.now()-this.startTime}getDelta(){return this.delta}getElapsed(){return this.elapsed}handleEvent(n){document.hidden||(this.currentTime=performance.now()-this.startTime)}dispose(){this.autoReset=!1}},sf=(()=>{const n=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),e=new Lh;return e.setAttribute("position",new Es(n,3)),e.setAttribute("uv",new Es(t,2)),e})(),Ht=class jo{static get fullscreenGeometry(){return sf}constructor(t="Pass",e=new Ra,r=new vi){this.name=t,this.renderer=null,this.scene=e,this.camera=r,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(t){if(this.rtt===t){const e=this.fullscreenMaterial;e!==null&&(e.needsUpdate=!0),this.rtt=!t}}set mainScene(t){}set mainCamera(t){}setRenderer(t){this.renderer=t}isEnabled(){return this.enabled}setEnabled(t){this.enabled=t}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(t){let e=this.screen;e!==null?e.material=t:(e=new mi(jo.fullscreenGeometry,t),e.frustumCulled=!1,this.scene===null&&(this.scene=new Ra),this.scene.add(e),this.screen=e)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(t){this.fullscreenMaterial=t}getDepthTexture(){return null}setDepthTexture(t,e=$a){}render(t,e,r,a,o){throw new Error("Render method not implemented!")}setSize(t,e){}initialize(t,e,r){}dispose(){for(const t of Object.keys(this)){const e=this[t];(e instanceof Nn||e instanceof Wu||e instanceof zu||e instanceof jo)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},uf=class extends Ht{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(n,t,e,r,a){const o=n.state.buffers.stencil;o.setLocked(!1),o.setTest(!1)}},cf=`#ifdef COLOR_WRITE
#include <common>
...
`;for(const b of a.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(const y of b[1].split(/\s*,\s*/))e.varyings.add(y),p.add(y),v.add(y);for(const b of a.matchAll(s))v.add(b[1])}for(const x of r.matchAll(s))v.add(x[1]);for(const x of t.defines.keys())v.add(x.replace(/\([\w\s,]*\)/g,""));for(const x of t.uniforms.keys())v.add(x);v.delete("while"),v.delete("for"),v.delete("if"),t.uniforms.forEach((x,b)=>e.uniforms.set(n+b.charAt(0).toUpperCase()+b.slice(1),x)),t.defines.forEach((x,b)=>e.defines.set(n+b.charAt(0).toUpperCase()+b.slice(1),x));const m=new Map([["fragment",r],["vertex",a]]);As(n,v,e.defines),As(n,v,m),r=m.get("fragment"),a=m.get("vertex");const g=t.blendMode;if(e.blendModes.set(g.blendFunction,g),o){t.inputColorSpace!==null&&t.inputColorSpace!==e.colorSpace&&(h+=t.inputColorSpace===at?`color0 = sRGBTransferOETF(color0);
	...
	`),t.outputColorSpace!==Lu?e.colorSpace=t.outputColorSpace:t.inputColorSpace!==null&&(e.colorSpace=t.inputColorSpace);const x=/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;h+=`${n}MainImage(color0, UV, `,(e.attributes&In.DEPTH)!==0&&x.test(r)&&(h+="depth, ",e.readDepth=!0),h+=`color1);
